      ...
      <div>
        ...
        <div>
          <input
            ...
            name="address"
            required
            className="w-full rounded-full border border-stone-200 px-4 py-2 text-sm outline-none transition-all duration-100
            placeholder:text-stone-300 focus:ring focus:ring-yellow-400 md:px-6 md:py-3"
          />
        </div>
      </div>
